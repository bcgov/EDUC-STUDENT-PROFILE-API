...
COMMENT ON COLUMN STUDENT_PROFILE_REQUEST_EVENT.EVENT_TYPE IS 'The type of event: UPDATE_STUDENT_PROFILE, GET_STUDENT_PROFILE, STUDENT_PROFILE_EVENT_OUTBOX_PROCESSED, ADD_STUDENT_PROFILE_COMMENT.';
COMMENT ON COLUMN STUDENT_PROFILE_REQUEST_EVENT.SAGA_ID IS 'The unique ID of saga.';
COMMENT ON COLUMN STUDENT_PROFILE_REQUEST_EVENT.EVENT_OUTCOME IS 'The outcome of processing event: STUDENT_PROFILE_UPDATED, STUDENT_PROFILE_FOUND, STUDENT_PROFILE_NOT_FOUND, STUDENT_PROFILE_COMMENT_ADDED, STUDENT_PROFILE_COMMENT_ALREADY_EXIST.';
