...
public class MessageSubscriber implements Closeable {
  ...
  public void subscribe() throws InterruptedException, TimeoutException, IOException {
    SubscriptionOptions options = new SubscriptionOptions.Builder().durableName("student-profile-request-api-consumer").build();
    connection.subscribe(STUDENT_PROFILE_API_TOPIC.toString(), "student-profile-request-api", this::onPenRequestTopicMessage, options);
  }
