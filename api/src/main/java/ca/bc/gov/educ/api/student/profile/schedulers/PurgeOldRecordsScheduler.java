...
public class PurgeOldRecordsScheduler {
  ...
  public PurgeOldRecordsScheduler(final StudentProfileRequestEventRepository studentProfileRequestEventRepository) {
  ...
  public void purgeOldRecords() {
    ...
    this.studentProfileRequestEventRepository.deleteByCreateDateBefore(createDateToCompare);
